...
Quest::Quest(int id, bool bombe, bool bombeUp, bool life, bool light, int disguise, int key, int giveOption, int giveMode, int removeFamilly, int famillyId, std::string titre, std::string) : IdElement(id)
{
	this->bombe = bombe;
...
Quest::Quest(int id, bool bombe, bool bombeUp, bool life, bool light, int disguise, int key, int giveOption, int giveMode, int removeFamilly, std::string titre, std::string description) : IdElement(id)
{
	this->bombe = bombe;
	this->bombeUp = bombeUp;
	this->disguise = disguise;
